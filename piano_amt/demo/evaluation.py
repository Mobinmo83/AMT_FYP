...
def _event_error_analysis(
    ...
    """Same event-level supplementary analysis logic as evaluate_advanced.py."""
    result = {
        "offset_mae_ms": 0.0,
        "onset_mae_ms": 0.0,
...
def _frame_metrics_like_evaluate_advanced(
    ...
    """Apply M2/M6 frame preprocessing before Frame F1, matching evaluate_advanced.py."""
...
def evaluate_prediction_vs_gt(
    ...
    **decoder_overrides,
    ...
    """Evaluate one demo prediction with the same logic as evaluate_advanced.py."""
